    ...
    phases: [
      ...
      },
      {
        ...
        tasks: [
          ...
          { id: 'W0.4', name: 'Add ticket error codes', status: 'pending' },
          {
            id: 'W0.5',
      ...
      },
      {
        ...
        tasks: [
          { id: 'W1.1', name: 'Create conversations table', status: 'pending' },
          { id: 'W1.2', name: 'Create tickets table', status: 'pending' },
          { id: 'W1.3', name: 'Create ticketEvents table', status: 'pending' },
          { id: 'W1.4', name: 'Create ticketNotes table', status: 'pending' },
          { id: 'W1.5', name: 'Create categories table', status: 'pending' },
          { id: 'W1.6', name: 'Create quickActions table', status: 'pending' },
          {
            id: 'W1.7',
          ...
          { id: 'W1.11', name: 'Mutation: closeTicket', status: 'pending' },
          { id: 'W1.12', name: 'Mutation: reopenTicket', status: 'pending' },
          { id: 'W1.13', name: 'Mutation: reassignTicket', status: 'pending' },
          {
            id: 'W1.14',
            name: 'Mutation: reclassifyTicket',
            status: 'pending',
          },
          { id: 'W1.15', name: 'Mutation: flagAbusive', status: 'pending' },
          { id: 'W1.16', name: 'Mutation: addTicketNote', status: 'pending' },
          { id: 'W1.17', name: 'Mutations: category CRUD', status: 'pending' },
          {
            id: 'W1.18',
          ...
          { id: 'W1.20', name: 'Query: getTicket', status: 'pending' },
          { id: 'W1.21', name: 'Query: listTicketEvents', status: 'pending' },
          { id: 'W1.22', name: 'Query: listTicketNotes', status: 'pending' },
          {
            id: 'W1.23',
            name: 'Query: searchClosedTickets',
            status: 'pending',
          },
          { id: 'W1.24', name: 'Query: countByStatus', status: 'pending' },
          {
            id: 'W1.25',
